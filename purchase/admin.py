...
class POItemInline(admin.TabularInline):
    ...
    fields = ('material', 'measure', 'price', 'cnt')
...
class PurchaseItemAdmin(generic.BOAdmin):
    ...
    list_display = ['po',  'material', 'vender', 'cnt', 'measure', 'price', 'amount', 'is_in_stock']
    fields = ('po', 'material', 'cnt', 'measure', 'price', 'amount', 'is_in_stock')
    # readonly_fields = ['po', 'material', 'cnt', 'price', 'tax']
    readonly_fields = ['po', 'material', 'cnt', 'measure', 'price']
