...
class POItem(models.Model):
    ...
    # 数量
    cnt = models.DecimalField(_("count"), max_digits=12, decimal_places=2, blank=True, null=True)
    # 折后单价
    ...
    # 入库数量
    entry_cnt = models.DecimalField(_("entry count"), max_digits=12, decimal_places=2, blank=True, null=True)
    # 剩余数量
    left_cnt = models.DecimalField(_("left count"), max_digits=12, decimal_places=2, blank=True, null=True)
...
class Invoice(generic.BO):
    ...
    # 采购金额
    po_amount = models.DecimalField(_("po amount"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 发票金额
    vo_amount = models.DecimalField(_("invoice amount"), max_digits=14, decimal_places=2)
    # 发票文件
...
class Payment(generic.BO):
    ...
    po_amount = models.DecimalField(_("po amount"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 支付金额
    py_amount = models.DecimalField(_("pay amount"), max_digits=14, decimal_places=2)
    # 银行账户
