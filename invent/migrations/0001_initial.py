    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='money of amount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnt', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='count')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('execute_time', models.DateTimeField(blank=True, null=True, verbose_name='execute time')),
                ('amount', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='stock in money of amount')),
                ('batch', models.CharField(blank=True, max_length=20, null=True, verbose_name='batch')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='organ.Organization', verbose_name='organization')),
