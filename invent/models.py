...
class InitialInventory(generic.BO):
    ...
    # 金额
    amount = models.DecimalField(_('money of amount'), max_digits=14, decimal_places=2, blank=True, null=True)
...
class StockIn(generic.BO):
    ...
    # 入库金额
    amount = models.DecimalField(_("stock in money of amount"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 批次号
    batch = models.CharField(_("batch"), max_length=const.DB_CHAR_NAME_20, blank=True, null=True)
...
class InOutDetail(models.Model):
    ...
    # 数量
    cnt = models.DecimalField(_("count"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 批次号
    batch = models.CharField(_("batch"), max_length=const.DB_CHAR_NAME_20, blank=True, null=True)
    # 金额
    price = models.DecimalField(_("price"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 增减属性
...
class ReturnItem(InOutDetail):
    ...
    out_cnt = models.DecimalField(_("out count"), max_digits=14, decimal_places=2)
