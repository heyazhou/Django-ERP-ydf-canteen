...
class SaleItem(models.Model):
    ...
    cnt = models.DecimalField(_("count"), max_digits=14, decimal_places=2)
    stock_price = models.DecimalField(_("stock price"), max_digits=14, decimal_places=2, blank=True, null=True)
    sale_price = models.DecimalField(_("sale price"), max_digits=14, decimal_places=2, blank=True, null=True)
    discount_price = models.DecimalField(_("discount price"), max_digits=14, decimal_places=2, blank=True, null=True)
...
class PaymentCollection(generic.BO):
    ...
    # 合同金额？
    order_amount = models.DecimalField(_("order amount"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 到账金额？
    collection_amount = models.DecimalField(_("collection amount"), max_digits=14, decimal_places=2)
    # 银行
...
class OfferItem(models.Model):
    ...
    # 成本单价
    cost_price = models.DecimalField(_("cost price"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 库存单价？
    stock_price = models.DecimalField(_("stock price"), max_digits=14, decimal_places=2, blank=True, null=True)
    # 销售单价
    sale_price = models.DecimalField(_("sale price"), max_digits=14, decimal_places=2, blank=True, null=True)
