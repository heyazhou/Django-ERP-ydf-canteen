    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_price', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='cost price')),
                ('stock_price', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='stock price')),
                ('sale_price', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='sale price')),
                ('discount_price', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='discount price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_amount', models.DecimalField(blank=True,decimal_places=2, max_digits=14, null=True, verbose_name='order amount')),
